...
public class HelloWorld {
    public static void main(String[] args) {
        ...
        double[] COEFFSCRI = new double[]{
                ...
                1,0.5,0.5,0.5,0.5,1,0.5,1,1,0.5,1,
                0.5,1,1,1,0.5,1,0.5,1,1,1,
                1,0.5,1,0.5,1
        };
        double[] COEFFSPRO = new double[]{
                0.9,0.7,0.3,0.3,0.9,0.3,0.3,0.3,0.3,0.9,
                0.7,0.3,0.3,0.3,0.7,0.3,0.7,0.7, 0.7,0.1,
                0.3,0.3,0.3,0.3,0.3,0.3,0.3,0.3,0.3,0.3,
                0.7,0.3,0.3,0.7,0.3,0.3,0.7,0.7,0.3,0.3,
                0.5,0.3,0.5,0.7,0.9
        };
